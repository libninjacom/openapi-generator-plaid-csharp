...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferSweepListRequest")]
    public partial class TransferSweepListRequest : IEquatable<TransferSweepListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferSweepListRequest" /> class.
        /// </summary>
        ...
        /// <param name="startDate">The start datetime of sweeps to return (RFC 3339 format)..</param>
        /// <param name="endDate">The end datetime of sweeps to return (RFC 3339 format)..</param>
        /// <param name="count">The maximum number of sweeps to return. (default to 25).</param>
        /// <param name="offset">The number of sweeps to skip before returning results. (default to 0).</param>
        public TransferSweepListRequest(string clientId = default(string), string secret = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? count = 25, int offset = 0)
        {
        ...
        /// </summary>
        /// <value>The number of sweeps to skip before returning results.</value>
        ...
        {
            return this.Equals(input as TransferSweepListRequest);
        }

        /// <summary>
        /// Returns true if TransferSweepListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferSweepListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferSweepListRequest input)
        {
            if (input == null)
            {
                return false;
