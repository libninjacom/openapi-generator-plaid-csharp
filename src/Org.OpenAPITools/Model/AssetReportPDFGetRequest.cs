...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetReportPDFGetRequest")]
    public partial class AssetReportPDFGetRequest : IEquatable<AssetReportPDFGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportPDFGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetReportPDFGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportPDFGetRequest" /> class.
        /// </summary>
        ...
        public AssetReportPDFGetRequest(string clientId = default(string), string secret = default(string), string assetReportToken = default(string))
        {
            // to ensure "assetReportToken" is required (not null)
            if (assetReportToken == null)
            {
                throw new ArgumentNullException("assetReportToken is a required property for AssetReportPDFGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as AssetReportPDFGetRequest);
        }

        /// <summary>
        /// Returns true if AssetReportPDFGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReportPDFGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReportPDFGetRequest input)
        {
            if (input == null)
            {
                return false;
