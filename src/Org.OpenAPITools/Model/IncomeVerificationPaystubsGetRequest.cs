...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IncomeVerificationPaystubsGetRequest")]
    public partial class IncomeVerificationPaystubsGetRequest : IEquatable<IncomeVerificationPaystubsGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomeVerificationPaystubsGetRequest" /> class.
        /// </summary>
        ...
        /// <param name="incomeVerificationId">The ID of the verification for which to get paystub information..</param>
        /// <param name="accessToken">The access token associated with the Item data is being requested for..</param>
        public IncomeVerificationPaystubsGetRequest(string clientId = default(string), string secret = default(string), string incomeVerificationId = default(string), string accessToken = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the verification for which to get paystub information.</value>
        ...
        {
            return this.Equals(input as IncomeVerificationPaystubsGetRequest);
        }

        /// <summary>
        /// Returns true if IncomeVerificationPaystubsGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomeVerificationPaystubsGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomeVerificationPaystubsGetRequest input)
        {
            if (input == null)
            {
                return false;
