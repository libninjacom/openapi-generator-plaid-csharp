...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BankTransferGetRequest")]
    public partial class BankTransferGetRequest : IEquatable<BankTransferGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankTransferGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BankTransferGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BankTransferGetRequest" /> class.
        /// </summary>
        ...
        public BankTransferGetRequest(string clientId = default(string), string secret = default(string), string bankTransferId = default(string))
        {
            // to ensure "bankTransferId" is required (not null)
            if (bankTransferId == null)
            {
                throw new ArgumentNullException("bankTransferId is a required property for BankTransferGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as BankTransferGetRequest);
        }

        /// <summary>
        /// Returns true if BankTransferGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BankTransferGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankTransferGetRequest input)
        {
            if (input == null)
            {
                return false;
