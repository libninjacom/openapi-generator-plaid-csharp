...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityGetRequest")]
    public partial class IdentityGetRequest : IEquatable<IdentityGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IdentityGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityGetRequest" /> class.
        /// </summary>
        ...
        public IdentityGetRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), IdentityGetRequestOptions options = default(IdentityGetRequestOptions))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for IdentityGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as IdentityGetRequest);
        }

        /// <summary>
        /// Returns true if IdentityGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityGetRequest input)
        {
            if (input == null)
            {
                return false;
