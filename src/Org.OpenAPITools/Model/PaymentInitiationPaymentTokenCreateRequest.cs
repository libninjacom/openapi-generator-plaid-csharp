...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentInitiationPaymentTokenCreateRequest")]
    public partial class PaymentInitiationPaymentTokenCreateRequest : IEquatable<PaymentInitiationPaymentTokenCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInitiationPaymentTokenCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentInitiationPaymentTokenCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInitiationPaymentTokenCreateRequest" /> class.
        /// </summary>
        ...
        public PaymentInitiationPaymentTokenCreateRequest(string clientId = default(string), string secret = default(string), string paymentId = default(string))
        {
            // to ensure "paymentId" is required (not null)
            if (paymentId == null)
            {
                throw new ArgumentNullException("paymentId is a required property for PaymentInitiationPaymentTokenCreateRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as PaymentInitiationPaymentTokenCreateRequest);
        }

        /// <summary>
        /// Returns true if PaymentInitiationPaymentTokenCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentInitiationPaymentTokenCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentInitiationPaymentTokenCreateRequest input)
        {
            if (input == null)
            {
                return false;
