...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetReportAuditCopyGetRequest")]
    public partial class AssetReportAuditCopyGetRequest : IEquatable<AssetReportAuditCopyGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportAuditCopyGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetReportAuditCopyGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportAuditCopyGetRequest" /> class.
        /// </summary>
        ...
        /// <param name="auditCopyToken">The &#x60;audit_copy_token&#x60; granting access to the Audit Copy you would like to get. (required).</param>
        public AssetReportAuditCopyGetRequest(string clientId = default(string), string secret = default(string), string auditCopyToken = default(string))
        {
            // to ensure "auditCopyToken" is required (not null)
            if (auditCopyToken == null)
            {
                throw new ArgumentNullException("auditCopyToken is a required property for AssetReportAuditCopyGetRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The &#x60;audit_copy_token&#x60; granting access to the Audit Copy you would like to get.</value>
        ...
        {
            return this.Equals(input as AssetReportAuditCopyGetRequest);
        }

        /// <summary>
        /// Returns true if AssetReportAuditCopyGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReportAuditCopyGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReportAuditCopyGetRequest input)
        {
            if (input == null)
            {
                return false;
