...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvestmentsTransactionsGetRequest")]
    public partial class InvestmentsTransactionsGetRequest : IEquatable<InvestmentsTransactionsGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvestmentsTransactionsGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvestmentsTransactionsGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvestmentsTransactionsGetRequest" /> class.
        /// </summary>
        ...
        /// <param name="startDate">The earliest date for which to fetch transaction history. Dates should be formatted as YYYY-MM-DD. (required).</param>
        /// <param name="endDate">The most recent date for which to fetch transaction history. Dates should be formatted as YYYY-MM-DD. (required).</param>
        /// <param name="options">options.</param>
        public InvestmentsTransactionsGetRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), DateTime startDate = default(DateTime), DateTime endDate = default(DateTime), InvestmentsTransactionsGetRequestOptions options = default(InvestmentsTransactionsGetRequestOptions))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for InvestmentsTransactionsGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as InvestmentsTransactionsGetRequest);
        }

        /// <summary>
        /// Returns true if InvestmentsTransactionsGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InvestmentsTransactionsGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvestmentsTransactionsGetRequest input)
        {
            if (input == null)
            {
                return false;
