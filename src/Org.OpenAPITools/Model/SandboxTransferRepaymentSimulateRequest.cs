...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SandboxTransferRepaymentSimulateRequest")]
    public partial class SandboxTransferRepaymentSimulateRequest : IEquatable<SandboxTransferRepaymentSimulateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxTransferRepaymentSimulateRequest" /> class.
        /// </summary>
        ...
        public SandboxTransferRepaymentSimulateRequest(string clientId = default(string), string secret = default(string))
        {
        ...
        {
            return this.Equals(input as SandboxTransferRepaymentSimulateRequest);
        }

        /// <summary>
        /// Returns true if SandboxTransferRepaymentSimulateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SandboxTransferRepaymentSimulateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxTransferRepaymentSimulateRequest input)
        {
            if (input == null)
            {
                return false;
