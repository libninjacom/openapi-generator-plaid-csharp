...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinkTokenCreateDepositoryFilter")]
    public partial class LinkTokenCreateDepositoryFilter : Dictionary<String, Object>, IEquatable<LinkTokenCreateDepositoryFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkTokenCreateDepositoryFilter" /> class.
        /// </summary>
        ...
        public LinkTokenCreateDepositoryFilter(List<DepositoryAccountSubtype> accountSubtypes = default(List<DepositoryAccountSubtype>)) : base()
        {
        ...
        {
            return this.Equals(input as LinkTokenCreateDepositoryFilter);
        }

        /// <summary>
        /// Returns true if LinkTokenCreateDepositoryFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkTokenCreateDepositoryFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkTokenCreateDepositoryFilter input)
        {
            if (input == null)
            {
                return false;
