...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IncomeVerificationRefreshRequest")]
    public partial class IncomeVerificationRefreshRequest : IEquatable<IncomeVerificationRefreshRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomeVerificationRefreshRequest" /> class.
        /// </summary>
        ...
        public IncomeVerificationRefreshRequest(string clientId = default(string), string secret = default(string), string incomeVerificationId = default(string), string accessToken = default(string))
        {
        ...
        {
            return this.Equals(input as IncomeVerificationRefreshRequest);
        }

        /// <summary>
        /// Returns true if IncomeVerificationRefreshRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomeVerificationRefreshRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomeVerificationRefreshRequest input)
        {
            if (input == null)
            {
                return false;
