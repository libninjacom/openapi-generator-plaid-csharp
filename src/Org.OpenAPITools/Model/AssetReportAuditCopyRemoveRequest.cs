...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetReportAuditCopyRemoveRequest")]
    public partial class AssetReportAuditCopyRemoveRequest : IEquatable<AssetReportAuditCopyRemoveRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportAuditCopyRemoveRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetReportAuditCopyRemoveRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportAuditCopyRemoveRequest" /> class.
        /// </summary>
        ...
        /// <param name="auditCopyToken">The &#x60;audit_copy_token&#x60; granting access to the Audit Copy you would like to revoke. (required).</param>
        public AssetReportAuditCopyRemoveRequest(string clientId = default(string), string secret = default(string), string auditCopyToken = default(string))
        {
            // to ensure "auditCopyToken" is required (not null)
            if (auditCopyToken == null)
            {
                throw new ArgumentNullException("auditCopyToken is a required property for AssetReportAuditCopyRemoveRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The &#x60;audit_copy_token&#x60; granting access to the Audit Copy you would like to revoke.</value>
        ...
        {
            return this.Equals(input as AssetReportAuditCopyRemoveRequest);
        }

        /// <summary>
        /// Returns true if AssetReportAuditCopyRemoveRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReportAuditCopyRemoveRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReportAuditCopyRemoveRequest input)
        {
            if (input == null)
            {
                return false;
