...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LinkTokenCreateCreditFilter")]
    public partial class LinkTokenCreateCreditFilter : Dictionary<String, Object>, IEquatable<LinkTokenCreateCreditFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkTokenCreateCreditFilter" /> class.
        /// </summary>
        ...
        public LinkTokenCreateCreditFilter(List<CreditAccountSubtype> accountSubtypes = default(List<CreditAccountSubtype>)) : base()
        {
        ...
        {
            return this.Equals(input as LinkTokenCreateCreditFilter);
        }

        /// <summary>
        /// Returns true if LinkTokenCreateCreditFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkTokenCreateCreditFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkTokenCreateCreditFilter input)
        {
            if (input == null)
            {
                return false;
