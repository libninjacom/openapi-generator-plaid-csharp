...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentInitiationPaymentReverseRequest")]
    public partial class PaymentInitiationPaymentReverseRequest : IEquatable<PaymentInitiationPaymentReverseRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInitiationPaymentReverseRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentInitiationPaymentReverseRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInitiationPaymentReverseRequest" /> class.
        /// </summary>
        ...
        /// <param name="paymentId">The ID of the payment to reverse (required).</param>
        public PaymentInitiationPaymentReverseRequest(string clientId = default(string), string secret = default(string), string paymentId = default(string))
        {
            // to ensure "paymentId" is required (not null)
            if (paymentId == null)
            {
                throw new ArgumentNullException("paymentId is a required property for PaymentInitiationPaymentReverseRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The ID of the payment to reverse</value>
        ...
        {
            return this.Equals(input as PaymentInitiationPaymentReverseRequest);
        }

        /// <summary>
        /// Returns true if PaymentInitiationPaymentReverseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentInitiationPaymentReverseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentInitiationPaymentReverseRequest input)
        {
            if (input == null)
            {
                return false;
