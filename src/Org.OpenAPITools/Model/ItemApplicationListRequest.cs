...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ItemApplicationListRequest")]
    public partial class ItemApplicationListRequest : IEquatable<ItemApplicationListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemApplicationListRequest" /> class.
        /// </summary>
        ...
        public ItemApplicationListRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string))
        {
        ...
        {
            return this.Equals(input as ItemApplicationListRequest);
        }

        /// <summary>
        /// Returns true if ItemApplicationListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemApplicationListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemApplicationListRequest input)
        {
            if (input == null)
            {
                return false;
