...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NumbersACHNullable")]
    public partial class NumbersACHNullable : IEquatable<NumbersACHNullable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumbersACHNullable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NumbersACHNullable() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NumbersACHNullable" /> class.
        /// </summary>
        ...
        public NumbersACHNullable(string accountId = default(string), string account = default(string), string routing = default(string), string wireRouting = default(string))
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for NumbersACHNullable and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "account" is required (not null)
            if (account == null)
            {
                throw new ArgumentNullException("account is a required property for NumbersACHNullable and cannot be null");
            }
            this.Account = account;
            // to ensure "routing" is required (not null)
            if (routing == null)
            {
                throw new ArgumentNullException("routing is a required property for NumbersACHNullable and cannot be null");
            }
            this.Routing = routing;
            // to ensure "wireRouting" is required (not null)
            if (wireRouting == null)
            {
                throw new ArgumentNullException("wireRouting is a required property for NumbersACHNullable and cannot be null");
            }
        ...
        {
            return this.Equals(input as NumbersACHNullable);
        }

        /// <summary>
        /// Returns true if NumbersACHNullable instances are equal
        /// </summary>
        /// <param name="input">Instance of NumbersACHNullable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumbersACHNullable input)
        {
            if (input == null)
            {
                return false;
