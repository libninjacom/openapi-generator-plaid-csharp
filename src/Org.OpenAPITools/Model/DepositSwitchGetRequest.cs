...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DepositSwitchGetRequest")]
    public partial class DepositSwitchGetRequest : IEquatable<DepositSwitchGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositSwitchGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepositSwitchGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositSwitchGetRequest" /> class.
        /// </summary>
        ...
        public DepositSwitchGetRequest(string clientId = default(string), string secret = default(string), string depositSwitchId = default(string))
        {
            // to ensure "depositSwitchId" is required (not null)
            if (depositSwitchId == null)
            {
                throw new ArgumentNullException("depositSwitchId is a required property for DepositSwitchGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as DepositSwitchGetRequest);
        }

        /// <summary>
        /// Returns true if DepositSwitchGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DepositSwitchGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepositSwitchGetRequest input)
        {
            if (input == null)
            {
                return false;
