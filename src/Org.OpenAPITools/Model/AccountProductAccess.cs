...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountProductAccess")]
    public partial class AccountProductAccess : IEquatable<AccountProductAccess>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountProductAccess" /> class.
        /// </summary>
        ...
        public AccountProductAccess(bool? accountData = true, bool? statements = true, bool? taxDocuments = true)
        {
        ...
        {
            return this.Equals(input as AccountProductAccess);
        }

        /// <summary>
        /// Returns true if AccountProductAccess instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountProductAccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountProductAccess input)
        {
            if (input == null)
            {
                return false;
