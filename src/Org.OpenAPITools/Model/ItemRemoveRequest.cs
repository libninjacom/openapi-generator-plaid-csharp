...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ItemRemoveRequest")]
    public partial class ItemRemoveRequest : IEquatable<ItemRemoveRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemRemoveRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemRemoveRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemRemoveRequest" /> class.
        /// </summary>
        ...
        public ItemRemoveRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for ItemRemoveRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as ItemRemoveRequest);
        }

        /// <summary>
        /// Returns true if ItemRemoveRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemRemoveRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemRemoveRequest input)
        {
            if (input == null)
            {
                return false;
