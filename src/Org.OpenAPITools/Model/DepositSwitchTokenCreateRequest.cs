...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DepositSwitchTokenCreateRequest")]
    public partial class DepositSwitchTokenCreateRequest : IEquatable<DepositSwitchTokenCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositSwitchTokenCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepositSwitchTokenCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepositSwitchTokenCreateRequest" /> class.
        /// </summary>
        ...
        public DepositSwitchTokenCreateRequest(string clientId = default(string), string secret = default(string), string depositSwitchId = default(string))
        {
            // to ensure "depositSwitchId" is required (not null)
            if (depositSwitchId == null)
            {
                throw new ArgumentNullException("depositSwitchId is a required property for DepositSwitchTokenCreateRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as DepositSwitchTokenCreateRequest);
        }

        /// <summary>
        /// Returns true if DepositSwitchTokenCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DepositSwitchTokenCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepositSwitchTokenCreateRequest input)
        {
            if (input == null)
            {
                return false;
