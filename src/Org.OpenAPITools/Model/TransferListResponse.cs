...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferListResponse")]
    public partial class TransferListResponse : Dictionary<String, Object>, IEquatable<TransferListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferListResponse()
        {
        ...
        public TransferListResponse(List<Transfer> transfers = default(List<Transfer>), string requestId = default(string)) : base()
        {
            // to ensure "transfers" is required (not null)
            if (transfers == null)
            {
                throw new ArgumentNullException("transfers is a required property for TransferListResponse and cannot be null");
            }
            this.Transfers = transfers;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for TransferListResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as TransferListResponse);
        }

        /// <summary>
        /// Returns true if TransferListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferListResponse input)
        {
            if (input == null)
            {
                return false;
