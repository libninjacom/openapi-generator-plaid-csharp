...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentInitiationRecipient")]
    public partial class PaymentInitiationRecipient : Dictionary<String, Object>, IEquatable<PaymentInitiationRecipient>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentInitiationRecipient" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentInitiationRecipient()
        {
        ...
        public PaymentInitiationRecipient(string recipientId = default(string), string name = default(string), PaymentInitiationAddress address = default(PaymentInitiationAddress), string iban = default(string), RecipientBACSNullable bacs = default(RecipientBACSNullable), string emiRecipientId = default(string)) : base()
        {
            // to ensure "recipientId" is required (not null)
            if (recipientId == null)
            {
                throw new ArgumentNullException("recipientId is a required property for PaymentInitiationRecipient and cannot be null");
            }
            this.RecipientId = recipientId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PaymentInitiationRecipient and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as PaymentInitiationRecipient);
        }

        /// <summary>
        /// Returns true if PaymentInitiationRecipient instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentInitiationRecipient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentInitiationRecipient input)
        {
            if (input == null)
            {
                return false;
