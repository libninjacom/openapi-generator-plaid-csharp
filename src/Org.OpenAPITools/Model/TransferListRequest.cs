...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferListRequest")]
    public partial class TransferListRequest : IEquatable<TransferListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferListRequest" /> class.
        /// </summary>
        ...
        /// <param name="count">The maximum number of transfers to return. (default to 25).</param>
        /// <param name="offset">The number of transfers to skip before returning results. (default to 0).</param>
        /// <param name="originationAccountId">Filter transfers to only those originated through the specified origination account..</param>
        public TransferListRequest(string clientId = default(string), string secret = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int count = 25, int offset = 0, string originationAccountId = default(string))
        {
        ...
        /// </summary>
        /// <value>The maximum number of transfers to return.</value>
        ...
        /// </summary>
        /// <value>The number of transfers to skip before returning results.</value>
        ...
        /// </summary>
        /// <value>Filter transfers to only those originated through the specified origination account.</value>
        ...
        {
            return this.Equals(input as TransferListRequest);
        }

        /// <summary>
        /// Returns true if TransferListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferListRequest input)
        {
            if (input == null)
            {
                return false;
