...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ItemAccessTokenInvalidateRequest")]
    public partial class ItemAccessTokenInvalidateRequest : IEquatable<ItemAccessTokenInvalidateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemAccessTokenInvalidateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemAccessTokenInvalidateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemAccessTokenInvalidateRequest" /> class.
        /// </summary>
        ...
        public ItemAccessTokenInvalidateRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for ItemAccessTokenInvalidateRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as ItemAccessTokenInvalidateRequest);
        }

        /// <summary>
        /// Returns true if ItemAccessTokenInvalidateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemAccessTokenInvalidateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemAccessTokenInvalidateRequest input)
        {
            if (input == null)
            {
                return false;
