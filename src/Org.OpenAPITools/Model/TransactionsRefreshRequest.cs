...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionsRefreshRequest")]
    public partial class TransactionsRefreshRequest : IEquatable<TransactionsRefreshRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionsRefreshRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransactionsRefreshRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionsRefreshRequest" /> class.
        /// </summary>
        ...
        public TransactionsRefreshRequest(string clientId = default(string), string accessToken = default(string), string secret = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for TransactionsRefreshRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as TransactionsRefreshRequest);
        }

        /// <summary>
        /// Returns true if TransactionsRefreshRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionsRefreshRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionsRefreshRequest input)
        {
            if (input == null)
            {
                return false;
