...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransactionBase")]
    public partial class TransactionBase : Dictionary<String, Object>, IEquatable<TransactionBase>, IValidatableObject
    {
        /// <summary>
        ...
        public TransactionBase(TransactionTypeEnum? transactionType = default(TransactionTypeEnum?), string pendingTransactionId = default(string), string categoryId = default(string), List<string> category = default(List<string>), Location location = default(Location), PaymentMeta paymentMeta = default(PaymentMeta), string accountOwner = default(string), string name = default(string), string originalDescription = default(string), string accountId = default(string), decimal amount = default(decimal), string isoCurrencyCode = default(string), string unofficialCurrencyCode = default(string), DateTime date = default(DateTime), bool pending = default(bool), string transactionId = default(string), string merchantName = default(string), string checkNumber = default(string)) : base()
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for TransactionBase and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("isoCurrencyCode is a required property for TransactionBase and cannot be null");
            }
            this.IsoCurrencyCode = isoCurrencyCode;
            // to ensure "unofficialCurrencyCode" is required (not null)
            if (unofficialCurrencyCode == null)
            {
                throw new ArgumentNullException("unofficialCurrencyCode is a required property for TransactionBase and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionId is a required property for TransactionBase and cannot be null");
            }
        ...
        {
            return this.Equals(input as TransactionBase);
        }

        /// <summary>
        /// Returns true if TransactionBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionBase input)
        {
            if (input == null)
            {
                return false;
