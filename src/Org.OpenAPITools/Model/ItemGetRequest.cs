...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ItemGetRequest")]
    public partial class ItemGetRequest : IEquatable<ItemGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemGetRequest" /> class.
        /// </summary>
        ...
        public ItemGetRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for ItemGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as ItemGetRequest);
        }

        /// <summary>
        /// Returns true if ItemGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemGetRequest input)
        {
            if (input == null)
            {
                return false;
