...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetReportCreateRequestOptions")]
    public partial class AssetReportCreateRequestOptions : IEquatable<AssetReportCreateRequestOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportCreateRequestOptions" /> class.
        /// </summary>
        ...
        public AssetReportCreateRequestOptions(string clientReportId = default(string), string webhook = default(string), AssetReportUser user = default(AssetReportUser))
        {
        ...
        {
            return this.Equals(input as AssetReportCreateRequestOptions);
        }

        /// <summary>
        /// Returns true if AssetReportCreateRequestOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReportCreateRequestOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReportCreateRequestOptions input)
        {
            if (input == null)
            {
                return false;
