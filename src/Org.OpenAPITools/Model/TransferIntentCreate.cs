...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferIntentCreate")]
    public partial class TransferIntentCreate : Dictionary<String, Object>, IEquatable<TransferIntentCreate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferIntentCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferIntentCreate()
        {
        ...
        /// Initializes a new instance of the <see cref="TransferIntentCreate" /> class.
        /// </summary>
        /// <param name="id">Plaid&#39;s unique identifier for the transfer intent object. (required).</param>
        ...
        /// <param name="originationAccountId">Plaid’s unique identifier for the origination account for the intent. If not provided, the default account will be used. (required).</param>
        ...
        public TransferIntentCreate(string id = default(string), DateTime created = default(DateTime), StatusEnum status = default(StatusEnum), string accountId = default(string), string originationAccountId = default(string), string amount = default(string), TransferIntentCreateMode mode = default(TransferIntentCreateMode), ACHClass achClass = default(ACHClass), TransferUserInResponse user = default(TransferUserInResponse), string description = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>), string isoCurrencyCode = default(string)) : base()
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for TransferIntentCreate and cannot be null");
            }
            this.Id = id;
            ...
            {
                throw new ArgumentNullException("originationAccountId is a required property for TransferIntentCreate and cannot be null");
            }
            this.OriginationAccountId = originationAccountId;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for TransferIntentCreate and cannot be null");
            }
            this.Amount = amount;
            this.Mode = mode;
            ...
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for TransferIntentCreate and cannot be null");
            }
            this.User = user;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for TransferIntentCreate and cannot be null");
            }
            this.Description = description;
            // to ensure "isoCurrencyCode" is required (not null)
            if (isoCurrencyCode == null)
            {
                throw new ArgumentNullException("isoCurrencyCode is a required property for TransferIntentCreate and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Plaid&#39;s unique identifier for the transfer intent object.</value>
        ...
        {
            return this.Equals(input as TransferIntentCreate);
        }

        /// <summary>
        /// Returns true if TransferIntentCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferIntentCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferIntentCreate input)
        {
            if (input == null)
            {
                return false;
