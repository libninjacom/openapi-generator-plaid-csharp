...
namespace Org.OpenAPITools.Model
{
    ...
    /// The scopes object
    /// </summary>
    [DataContract(Name = "ScopesNullable")]
    public partial class ScopesNullable : IEquatable<ScopesNullable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScopesNullable" /> class.
        /// </summary>
        ...
        public ScopesNullable(ProductAccess productAccess = default(ProductAccess), List<AccountAccess> accounts = default(List<AccountAccess>), bool? newAccounts = true)
        {
        ...
        {
            return this.Equals(input as ScopesNullable);
        }

        /// <summary>
        /// Returns true if ScopesNullable instances are equal
        /// </summary>
        /// <param name="input">Instance of ScopesNullable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScopesNullable input)
        {
            if (input == null)
            {
                return false;
