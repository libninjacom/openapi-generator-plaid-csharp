...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WalletTransactionCounterpartyBACS")]
    public partial class WalletTransactionCounterpartyBACS : IEquatable<WalletTransactionCounterpartyBACS>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletTransactionCounterpartyBACS" /> class.
        /// </summary>
        ...
        public WalletTransactionCounterpartyBACS(string account = default(string), string sortCode = default(string))
        {
        ...
        {
            return this.Equals(input as WalletTransactionCounterpartyBACS);
        }

        /// <summary>
        /// Returns true if WalletTransactionCounterpartyBACS instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletTransactionCounterpartyBACS to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletTransactionCounterpartyBACS input)
        {
            if (input == null)
            {
                return false;
