...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SignalEvaluateResponse")]
    public partial class SignalEvaluateResponse : Dictionary<String, Object>, IEquatable<SignalEvaluateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignalEvaluateResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SignalEvaluateResponse()
        {
        ...
        /// <param name="coreAttributes">coreAttributes.</param>
        public SignalEvaluateResponse(string requestId = default(string), SignalScores scores = default(SignalScores), SignalEvaluateCoreAttributes coreAttributes = default(SignalEvaluateCoreAttributes)) : base()
        {
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for SignalEvaluateResponse and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "scores" is required (not null)
            if (scores == null)
            {
                throw new ArgumentNullException("scores is a required property for SignalEvaluateResponse and cannot be null");
            }
            this.Scores = scores;
        ...
        /// </summary>
        [DataMember(Name = "core_attributes", EmitDefaultValue = false)]
        public SignalEvaluateCoreAttributes CoreAttributes { get; set; }
        ...
        {
            return this.Equals(input as SignalEvaluateResponse);
        }

        /// <summary>
        /// Returns true if SignalEvaluateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SignalEvaluateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignalEvaluateResponse input)
        {
            if (input == null)
            {
                return false;
