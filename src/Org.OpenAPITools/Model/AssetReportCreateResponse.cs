...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetReportCreateResponse")]
    public partial class AssetReportCreateResponse : Dictionary<String, Object>, IEquatable<AssetReportCreateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportCreateResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetReportCreateResponse()
        {
        ...
        public AssetReportCreateResponse(string assetReportToken = default(string), string assetReportId = default(string), string requestId = default(string)) : base()
        {
            // to ensure "assetReportToken" is required (not null)
            if (assetReportToken == null)
            {
                throw new ArgumentNullException("assetReportToken is a required property for AssetReportCreateResponse and cannot be null");
            }
            this.AssetReportToken = assetReportToken;
            // to ensure "assetReportId" is required (not null)
            if (assetReportId == null)
            {
                throw new ArgumentNullException("assetReportId is a required property for AssetReportCreateResponse and cannot be null");
            }
            this.AssetReportId = assetReportId;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for AssetReportCreateResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as AssetReportCreateResponse);
        }

        /// <summary>
        /// Returns true if AssetReportCreateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReportCreateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReportCreateResponse input)
        {
            if (input == null)
            {
                return false;
