...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SandboxTransferSimulateRequest")]
    public partial class SandboxTransferSimulateRequest : IEquatable<SandboxTransferSimulateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxTransferSimulateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SandboxTransferSimulateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxTransferSimulateRequest" /> class.
        /// </summary>
        ...
        public SandboxTransferSimulateRequest(string clientId = default(string), string secret = default(string), string transferId = default(string), string eventType = default(string), TransferFailure failureReason = default(TransferFailure))
        {
            // to ensure "transferId" is required (not null)
            if (transferId == null)
            {
                throw new ArgumentNullException("transferId is a required property for SandboxTransferSimulateRequest and cannot be null");
            }
            this.TransferId = transferId;
            // to ensure "eventType" is required (not null)
            if (eventType == null)
            {
                throw new ArgumentNullException("eventType is a required property for SandboxTransferSimulateRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as SandboxTransferSimulateRequest);
        }

        /// <summary>
        /// Returns true if SandboxTransferSimulateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SandboxTransferSimulateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxTransferSimulateRequest input)
        {
            if (input == null)
            {
                return false;
