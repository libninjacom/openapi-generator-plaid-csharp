...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BankTransferBalanceGetRequest")]
    public partial class BankTransferBalanceGetRequest : IEquatable<BankTransferBalanceGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankTransferBalanceGetRequest" /> class.
        /// </summary>
        ...
        /// <param name="originationAccountId">If multiple origination accounts are available, &#x60;origination_account_id&#x60; must be used to specify the account for which balance will be returned..</param>
        public BankTransferBalanceGetRequest(string clientId = default(string), string secret = default(string), string originationAccountId = default(string))
        {
        ...
        /// </summary>
        /// <value>If multiple origination accounts are available, &#x60;origination_account_id&#x60; must be used to specify the account for which balance will be returned.</value>
        ...
        {
            return this.Equals(input as BankTransferBalanceGetRequest);
        }

        /// <summary>
        /// Returns true if BankTransferBalanceGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BankTransferBalanceGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankTransferBalanceGetRequest input)
        {
            if (input == null)
            {
                return false;
