...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferGetRequest")]
    public partial class TransferGetRequest : IEquatable<TransferGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferGetRequest" /> class.
        /// </summary>
        ...
        public TransferGetRequest(string clientId = default(string), string secret = default(string), string transferId = default(string))
        {
            // to ensure "transferId" is required (not null)
            if (transferId == null)
            {
                throw new ArgumentNullException("transferId is a required property for TransferGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as TransferGetRequest);
        }

        /// <summary>
        /// Returns true if TransferGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferGetRequest input)
        {
            if (input == null)
            {
                return false;
