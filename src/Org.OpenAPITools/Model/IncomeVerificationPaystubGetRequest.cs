...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IncomeVerificationPaystubGetRequest")]
    public partial class IncomeVerificationPaystubGetRequest : IEquatable<IncomeVerificationPaystubGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomeVerificationPaystubGetRequest" /> class.
        /// </summary>
        ...
        public IncomeVerificationPaystubGetRequest(string clientId = default(string), string secret = default(string), string incomeVerificationId = default(string), string accessToken = default(string))
        {
        ...
        {
            return this.Equals(input as IncomeVerificationPaystubGetRequest);
        }

        /// <summary>
        /// Returns true if IncomeVerificationPaystubGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomeVerificationPaystubGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomeVerificationPaystubGetRequest input)
        {
            if (input == null)
            {
                return false;
