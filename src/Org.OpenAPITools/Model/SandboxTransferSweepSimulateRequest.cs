...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SandboxTransferSweepSimulateRequest")]
    public partial class SandboxTransferSweepSimulateRequest : IEquatable<SandboxTransferSweepSimulateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxTransferSweepSimulateRequest" /> class.
        /// </summary>
        ...
        public SandboxTransferSweepSimulateRequest(string clientId = default(string), string secret = default(string))
        {
        ...
        {
            return this.Equals(input as SandboxTransferSweepSimulateRequest);
        }

        /// <summary>
        /// Returns true if SandboxTransferSweepSimulateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SandboxTransferSweepSimulateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxTransferSweepSimulateRequest input)
        {
            if (input == null)
            {
                return false;
