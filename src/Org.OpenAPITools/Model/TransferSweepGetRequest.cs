...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferSweepGetRequest")]
    public partial class TransferSweepGetRequest : IEquatable<TransferSweepGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferSweepGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransferSweepGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferSweepGetRequest" /> class.
        /// </summary>
        ...
        public TransferSweepGetRequest(string clientId = default(string), string secret = default(string), string sweepId = default(string))
        {
            // to ensure "sweepId" is required (not null)
            if (sweepId == null)
            {
                throw new ArgumentNullException("sweepId is a required property for TransferSweepGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as TransferSweepGetRequest);
        }

        /// <summary>
        /// Returns true if TransferSweepGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferSweepGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferSweepGetRequest input)
        {
            if (input == null)
            {
                return false;
