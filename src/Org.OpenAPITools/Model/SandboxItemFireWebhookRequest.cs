...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SandboxItemFireWebhookRequest")]
    public partial class SandboxItemFireWebhookRequest : IEquatable<SandboxItemFireWebhookRequest>, IValidatableObject
    {
        /// <summary>
        /// The following values for &#x60;webhook_code&#x60; are supported:  * &#x60;DEFAULT_UPDATE&#x60; * &#x60;NEW_ACCOUNTS_AVAILABLE&#x60;
        /// </summary>
        /// <value>The following values for &#x60;webhook_code&#x60; are supported:  * &#x60;DEFAULT_UPDATE&#x60; * &#x60;NEW_ACCOUNTS_AVAILABLE&#x60;</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum WebhookCodeEnum
        {
            /// <summary>
            /// Enum DEFAULTUPDATE for value: DEFAULT_UPDATE
            /// </summary>
            [EnumMember(Value = "DEFAULT_UPDATE")]
            DEFAULTUPDATE = 1,

            /// <summary>
            /// Enum NEWACCOUNTSAVAILABLE for value: NEW_ACCOUNTS_AVAILABLE
            /// </summary>
            [EnumMember(Value = "NEW_ACCOUNTS_AVAILABLE")]
            NEWACCOUNTSAVAILABLE = 2
        ...
        public WebhookCodeEnum WebhookCode { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxItemFireWebhookRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SandboxItemFireWebhookRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxItemFireWebhookRequest" /> class.
        /// </summary>
        ...
        /// <param name="webhookCode">The following values for &#x60;webhook_code&#x60; are supported:  * &#x60;DEFAULT_UPDATE&#x60; * &#x60;NEW_ACCOUNTS_AVAILABLE&#x60; (required).</param>
        public SandboxItemFireWebhookRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), WebhookCodeEnum webhookCode = default(WebhookCodeEnum))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for SandboxItemFireWebhookRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as SandboxItemFireWebhookRequest);
        }

        /// <summary>
        /// Returns true if SandboxItemFireWebhookRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SandboxItemFireWebhookRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxItemFireWebhookRequest input)
        {
            if (input == null)
            {
                return false;
