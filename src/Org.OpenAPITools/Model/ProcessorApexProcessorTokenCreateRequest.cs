...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProcessorApexProcessorTokenCreateRequest")]
    public partial class ProcessorApexProcessorTokenCreateRequest : IEquatable<ProcessorApexProcessorTokenCreateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessorApexProcessorTokenCreateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProcessorApexProcessorTokenCreateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessorApexProcessorTokenCreateRequest" /> class.
        /// </summary>
        ...
        public ProcessorApexProcessorTokenCreateRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), string accountId = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for ProcessorApexProcessorTokenCreateRequest and cannot be null");
            }
            this.AccessToken = accessToken;
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for ProcessorApexProcessorTokenCreateRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as ProcessorApexProcessorTokenCreateRequest);
        }

        /// <summary>
        /// Returns true if ProcessorApexProcessorTokenCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessorApexProcessorTokenCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessorApexProcessorTokenCreateRequest input)
        {
            if (input == null)
            {
                return false;
