...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SandboxItemResetLoginRequest")]
    public partial class SandboxItemResetLoginRequest : IEquatable<SandboxItemResetLoginRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxItemResetLoginRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SandboxItemResetLoginRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxItemResetLoginRequest" /> class.
        /// </summary>
        ...
        public SandboxItemResetLoginRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for SandboxItemResetLoginRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as SandboxItemResetLoginRequest);
        }

        /// <summary>
        /// Returns true if SandboxItemResetLoginRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SandboxItemResetLoginRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxItemResetLoginRequest input)
        {
            if (input == null)
            {
                return false;
