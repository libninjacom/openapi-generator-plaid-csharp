...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ItemWebhookUpdateRequest")]
    public partial class ItemWebhookUpdateRequest : IEquatable<ItemWebhookUpdateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemWebhookUpdateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemWebhookUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemWebhookUpdateRequest" /> class.
        /// </summary>
        ...
        /// <param name="webhook">The new webhook URL to associate with the Item..</param>
        public ItemWebhookUpdateRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), string webhook = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for ItemWebhookUpdateRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The new webhook URL to associate with the Item.</value>
        ...
        {
            return this.Equals(input as ItemWebhookUpdateRequest);
        }

        /// <summary>
        /// Returns true if ItemWebhookUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemWebhookUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemWebhookUpdateRequest input)
        {
            if (input == null)
            {
                return false;
