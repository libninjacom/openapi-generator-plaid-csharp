...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransferRepaymentListRequest")]
    public partial class TransferRepaymentListRequest : IEquatable<TransferRepaymentListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferRepaymentListRequest" /> class.
        /// </summary>
        ...
        /// <param name="startDate">The start datetime of repayments to return (RFC 3339 format)..</param>
        /// <param name="endDate">The end datetime of repayments to return (RFC 3339 format)..</param>
        ...
        public TransferRepaymentListRequest(string clientId = default(string), string secret = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? count = 25, int offset = 0)
        {
        ...
        /// </summary>
        /// <value>The start datetime of repayments to return (RFC 3339 format).</value>
        ...
        /// </summary>
        /// <value>The end datetime of repayments to return (RFC 3339 format).</value>
        ...
        {
            return this.Equals(input as TransferRepaymentListRequest);
        }

        /// <summary>
        /// Returns true if TransferRepaymentListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferRepaymentListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferRepaymentListRequest input)
        {
            if (input == null)
            {
                return false;
