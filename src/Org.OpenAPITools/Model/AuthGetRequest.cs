...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthGetRequest")]
    public partial class AuthGetRequest : IEquatable<AuthGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuthGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthGetRequest" /> class.
        /// </summary>
        ...
        public AuthGetRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), AuthGetRequestOptions options = default(AuthGetRequestOptions))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for AuthGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as AuthGetRequest);
        }

        /// <summary>
        /// Returns true if AuthGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthGetRequest input)
        {
            if (input == null)
            {
                return false;
