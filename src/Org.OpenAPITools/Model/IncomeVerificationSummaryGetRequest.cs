...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IncomeVerificationSummaryGetRequest")]
    public partial class IncomeVerificationSummaryGetRequest : IEquatable<IncomeVerificationSummaryGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomeVerificationSummaryGetRequest" /> class.
        /// </summary>
        ...
        public IncomeVerificationSummaryGetRequest(string clientId = default(string), string secret = default(string), string incomeVerificationId = default(string), string accessToken = default(string))
        {
        ...
        {
            return this.Equals(input as IncomeVerificationSummaryGetRequest);
        }

        /// <summary>
        /// Returns true if IncomeVerificationSummaryGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomeVerificationSummaryGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomeVerificationSummaryGetRequest input)
        {
            if (input == null)
            {
                return false;
