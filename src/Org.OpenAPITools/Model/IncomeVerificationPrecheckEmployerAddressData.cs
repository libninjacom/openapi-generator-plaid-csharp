...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IncomeVerificationPrecheckEmployerAddressData")]
    public partial class IncomeVerificationPrecheckEmployerAddressData : Dictionary<String, Object>, IEquatable<IncomeVerificationPrecheckEmployerAddressData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncomeVerificationPrecheckEmployerAddressData" /> class.
        /// </summary>
        ...
        public IncomeVerificationPrecheckEmployerAddressData(string city = default(string), string region = default(string), string street = default(string), string postalCode = default(string), string country = default(string)) : base()
        {
            this.City = city;
            this.Region = region;
            this.Street = street;
        ...
        {
            return this.Equals(input as IncomeVerificationPrecheckEmployerAddressData);
        }

        /// <summary>
        /// Returns true if IncomeVerificationPrecheckEmployerAddressData instances are equal
        /// </summary>
        /// <param name="input">Instance of IncomeVerificationPrecheckEmployerAddressData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncomeVerificationPrecheckEmployerAddressData input)
        {
            if (input == null)
            {
                return false;
