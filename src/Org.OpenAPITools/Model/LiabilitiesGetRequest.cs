...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LiabilitiesGetRequest")]
    public partial class LiabilitiesGetRequest : IEquatable<LiabilitiesGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiabilitiesGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LiabilitiesGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LiabilitiesGetRequest" /> class.
        /// </summary>
        ...
        public LiabilitiesGetRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), LiabilitiesGetRequestOptions options = default(LiabilitiesGetRequestOptions))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for LiabilitiesGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as LiabilitiesGetRequest);
        }

        /// <summary>
        /// Returns true if LiabilitiesGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LiabilitiesGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LiabilitiesGetRequest input)
        {
            if (input == null)
            {
                return false;
