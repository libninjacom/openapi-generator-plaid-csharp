...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SandboxItemSetVerificationStatusRequest")]
    public partial class SandboxItemSetVerificationStatusRequest : IEquatable<SandboxItemSetVerificationStatusRequest>, IValidatableObject
    {
        /// <summary>
        /// The verification status to set the account to.
        /// </summary>
        /// <value>The verification status to set the account to.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxItemSetVerificationStatusRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SandboxItemSetVerificationStatusRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SandboxItemSetVerificationStatusRequest" /> class.
        /// </summary>
        ...
        /// <param name="verificationStatus">The verification status to set the account to. (required).</param>
        public SandboxItemSetVerificationStatusRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), string accountId = default(string), VerificationStatusEnum verificationStatus = default(VerificationStatusEnum))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for SandboxItemSetVerificationStatusRequest and cannot be null");
            }
            this.AccessToken = accessToken;
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for SandboxItemSetVerificationStatusRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as SandboxItemSetVerificationStatusRequest);
        }

        /// <summary>
        /// Returns true if SandboxItemSetVerificationStatusRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SandboxItemSetVerificationStatusRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SandboxItemSetVerificationStatusRequest input)
        {
            if (input == null)
            {
                return false;
