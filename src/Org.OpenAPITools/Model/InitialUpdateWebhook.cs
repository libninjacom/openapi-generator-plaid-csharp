...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InitialUpdateWebhook")]
    public partial class InitialUpdateWebhook : Dictionary<String, Object>, IEquatable<InitialUpdateWebhook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitialUpdateWebhook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InitialUpdateWebhook()
        {
        ...
        /// <param name="webhookCode">&#x60;INITIAL_UPDATE&#x60; (required).</param>
        /// <param name="error">The error code associated with the webhook..</param>
        ...
        public InitialUpdateWebhook(string webhookType = default(string), string webhookCode = default(string), string error = default(string), decimal newTransactions = default(decimal), string itemId = default(string)) : base()
        {
            // to ensure "webhookType" is required (not null)
            if (webhookType == null)
            {
                throw new ArgumentNullException("webhookType is a required property for InitialUpdateWebhook and cannot be null");
            }
            this.WebhookType = webhookType;
            // to ensure "webhookCode" is required (not null)
            if (webhookCode == null)
            {
                throw new ArgumentNullException("webhookCode is a required property for InitialUpdateWebhook and cannot be null");
            }
            ...
            if (itemId == null)
            {
                throw new ArgumentNullException("itemId is a required property for InitialUpdateWebhook and cannot be null");
            }
            this.ItemId = itemId;
            this.Error = error;
            this.AdditionalProperties = new Dictionary<string, object>();
        ...
        /// </summary>
        /// <value>The error code associated with the webhook.</value>
        ...
        {
            return this.Equals(input as InitialUpdateWebhook);
        }

        /// <summary>
        /// Returns true if InitialUpdateWebhook instances are equal
        /// </summary>
        /// <param name="input">Instance of InitialUpdateWebhook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitialUpdateWebhook input)
        {
            if (input == null)
            {
                return false;
