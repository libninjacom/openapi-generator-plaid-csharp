...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvestmentsHoldingsGetRequest")]
    public partial class InvestmentsHoldingsGetRequest : IEquatable<InvestmentsHoldingsGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvestmentsHoldingsGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvestmentsHoldingsGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvestmentsHoldingsGetRequest" /> class.
        /// </summary>
        ...
        public InvestmentsHoldingsGetRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string), InvestmentHoldingsGetRequestOptions options = default(InvestmentHoldingsGetRequestOptions))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for InvestmentsHoldingsGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as InvestmentsHoldingsGetRequest);
        }

        /// <summary>
        /// Returns true if InvestmentsHoldingsGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InvestmentsHoldingsGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvestmentsHoldingsGetRequest input)
        {
            if (input == null)
            {
                return false;
