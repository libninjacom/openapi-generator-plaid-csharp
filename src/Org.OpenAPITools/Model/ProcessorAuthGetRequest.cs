...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProcessorAuthGetRequest")]
    public partial class ProcessorAuthGetRequest : IEquatable<ProcessorAuthGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessorAuthGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProcessorAuthGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessorAuthGetRequest" /> class.
        /// </summary>
        ...
        public ProcessorAuthGetRequest(string clientId = default(string), string secret = default(string), string processorToken = default(string))
        {
            // to ensure "processorToken" is required (not null)
            if (processorToken == null)
            {
                throw new ArgumentNullException("processorToken is a required property for ProcessorAuthGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as ProcessorAuthGetRequest);
        }

        /// <summary>
        /// Returns true if ProcessorAuthGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProcessorAuthGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessorAuthGetRequest input)
        {
            if (input == null)
            {
                return false;
