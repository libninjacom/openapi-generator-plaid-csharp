...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PlaidError")]
    public partial class PlaidError : IEquatable<PlaidError>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaidError" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlaidError() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlaidError" /> class.
        /// </summary>
        ...
        public PlaidError(ErrorTypeEnum errorType = default(ErrorTypeEnum), string errorCode = default(string), string errorMessage = default(string), string displayMessage = default(string), string requestId = default(string), List<Object> causes = default(List<Object>), decimal? status = default(decimal?), string documentationUrl = default(string), string suggestedAction = default(string))
        {
            this.ErrorType = errorType;
            // to ensure "errorCode" is required (not null)
            if (errorCode == null)
            {
                throw new ArgumentNullException("errorCode is a required property for PlaidError and cannot be null");
            }
            this.ErrorCode = errorCode;
            // to ensure "errorMessage" is required (not null)
            if (errorMessage == null)
            {
                throw new ArgumentNullException("errorMessage is a required property for PlaidError and cannot be null");
            }
            this.ErrorMessage = errorMessage;
            // to ensure "displayMessage" is required (not null)
            if (displayMessage == null)
            {
                throw new ArgumentNullException("displayMessage is a required property for PlaidError and cannot be null");
            }
        ...
        {
            return this.Equals(input as PlaidError);
        }

        /// <summary>
        /// Returns true if PlaidError instances are equal
        /// </summary>
        /// <param name="input">Instance of PlaidError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaidError input)
        {
            if (input == null)
            {
                return false;
