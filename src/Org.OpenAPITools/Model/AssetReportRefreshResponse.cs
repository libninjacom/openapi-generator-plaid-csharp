...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetReportRefreshResponse")]
    public partial class AssetReportRefreshResponse : Dictionary<String, Object>, IEquatable<AssetReportRefreshResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportRefreshResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetReportRefreshResponse()
        {
        ...
        public AssetReportRefreshResponse(string assetReportId = default(string), string assetReportToken = default(string), string requestId = default(string)) : base()
        {
            // to ensure "assetReportId" is required (not null)
            if (assetReportId == null)
            {
                throw new ArgumentNullException("assetReportId is a required property for AssetReportRefreshResponse and cannot be null");
            }
            this.AssetReportId = assetReportId;
            // to ensure "assetReportToken" is required (not null)
            if (assetReportToken == null)
            {
                throw new ArgumentNullException("assetReportToken is a required property for AssetReportRefreshResponse and cannot be null");
            }
            this.AssetReportToken = assetReportToken;
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for AssetReportRefreshResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as AssetReportRefreshResponse);
        }

        /// <summary>
        /// Returns true if AssetReportRefreshResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReportRefreshResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReportRefreshResponse input)
        {
            if (input == null)
            {
                return false;
