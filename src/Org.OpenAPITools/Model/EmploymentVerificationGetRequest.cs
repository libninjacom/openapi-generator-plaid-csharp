...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmploymentVerificationGetRequest")]
    public partial class EmploymentVerificationGetRequest : IEquatable<EmploymentVerificationGetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentVerificationGetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmploymentVerificationGetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentVerificationGetRequest" /> class.
        /// </summary>
        ...
        public EmploymentVerificationGetRequest(string clientId = default(string), string secret = default(string), string accessToken = default(string))
        {
            // to ensure "accessToken" is required (not null)
            if (accessToken == null)
            {
                throw new ArgumentNullException("accessToken is a required property for EmploymentVerificationGetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as EmploymentVerificationGetRequest);
        }

        /// <summary>
        /// Returns true if EmploymentVerificationGetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EmploymentVerificationGetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmploymentVerificationGetRequest input)
        {
            if (input == null)
            {
                return false;
