...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AssetReportRemoveRequest")]
    public partial class AssetReportRemoveRequest : IEquatable<AssetReportRemoveRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportRemoveRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetReportRemoveRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetReportRemoveRequest" /> class.
        /// </summary>
        ...
        public AssetReportRemoveRequest(string clientId = default(string), string secret = default(string), string assetReportToken = default(string))
        {
            // to ensure "assetReportToken" is required (not null)
            if (assetReportToken == null)
            {
                throw new ArgumentNullException("assetReportToken is a required property for AssetReportRemoveRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as AssetReportRemoveRequest);
        }

        /// <summary>
        /// Returns true if AssetReportRemoveRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AssetReportRemoveRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssetReportRemoveRequest input)
        {
            if (input == null)
            {
                return false;
