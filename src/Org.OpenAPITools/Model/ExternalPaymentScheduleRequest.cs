...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExternalPaymentScheduleRequest")]
    public partial class ExternalPaymentScheduleRequest : Dictionary<String, Object>, IEquatable<ExternalPaymentScheduleRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalPaymentScheduleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExternalPaymentScheduleRequest()
        {
        ...
        public ExternalPaymentScheduleRequest(PaymentScheduleInterval interval = default(PaymentScheduleInterval), int intervalExecutionDay = default(int), DateTime startDate = default(DateTime), DateTime? endDate = default(DateTime?), DateTime? adjustedStartDate = default(DateTime?)) : base()
        {
        ...
        {
            return this.Equals(input as ExternalPaymentScheduleRequest);
        }

        /// <summary>
        /// Returns true if ExternalPaymentScheduleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalPaymentScheduleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalPaymentScheduleRequest input)
        {
            if (input == null)
            {
                return false;
