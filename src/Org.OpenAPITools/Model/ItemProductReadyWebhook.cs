...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ItemProductReadyWebhook")]
    public partial class ItemProductReadyWebhook : Dictionary<String, Object>, IEquatable<ItemProductReadyWebhook>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemProductReadyWebhook" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemProductReadyWebhook()
        {
        ...
        public ItemProductReadyWebhook(string webhookType = default(string), string webhookCode = default(string), string itemId = default(string), PlaidError error = default(PlaidError)) : base()
        {
            // to ensure "webhookType" is required (not null)
            if (webhookType == null)
            {
                throw new ArgumentNullException("webhookType is a required property for ItemProductReadyWebhook and cannot be null");
            }
            this.WebhookType = webhookType;
            // to ensure "webhookCode" is required (not null)
            if (webhookCode == null)
            {
                throw new ArgumentNullException("webhookCode is a required property for ItemProductReadyWebhook and cannot be null");
            }
            this.WebhookCode = webhookCode;
            // to ensure "itemId" is required (not null)
            if (itemId == null)
            {
                throw new ArgumentNullException("itemId is a required property for ItemProductReadyWebhook and cannot be null");
            }
            this.ItemId = itemId;
            this.Error = error;
            this.AdditionalProperties = new Dictionary<string, object>();
        ...
        {
            return this.Equals(input as ItemProductReadyWebhook);
        }

        /// <summary>
        /// Returns true if ItemProductReadyWebhook instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemProductReadyWebhook to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemProductReadyWebhook input)
        {
            if (input == null)
            {
                return false;
