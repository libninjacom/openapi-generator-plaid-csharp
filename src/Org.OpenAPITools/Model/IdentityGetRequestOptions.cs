...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityGetRequestOptions")]
    public partial class IdentityGetRequestOptions : IEquatable<IdentityGetRequestOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityGetRequestOptions" /> class.
        /// </summary>
        ...
        public IdentityGetRequestOptions(List<string> accountIds = default(List<string>))
        {
        ...
        {
            return this.Equals(input as IdentityGetRequestOptions);
        }

        /// <summary>
        /// Returns true if IdentityGetRequestOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityGetRequestOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityGetRequestOptions input)
        {
            if (input == null)
            {
                return false;
